 ...
 * Use: jia.has_object_in_path( +Xori,+Yori,+Xto,+Yto,+T,-X,-Y,-D);
 * (Xori,Yori) is the origin and (Xto,Yto) is the destination, (X,Y) is the position with depth D where there is an object with the desired Type T.
 * @author jomi
 */
