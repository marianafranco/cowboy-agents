...
public final class Vec implements Serializable, Cloneable, Comparable<Vec> {
    ...
    public Vec(WorldModel model, Location l) {
        this.x = l.x;
    ...
    /** create a vector based on a location in the model */
    public Vec(WorldModel model, int x, int y) {
        this.x = x;
    ...
    public Location getLocation(WorldModel model) {
